...
extern
int32_t spear_arm_JointCommand_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, spear_arm_JointCommand* dest, uint8_t** dyn_arr_buf, int32_t offset);
