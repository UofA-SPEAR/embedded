...
uint32_t uavcan_protocol_AccessCommandShellRequest_encode_internal(uavcan_protocol_AccessCommandShellRequest* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    {
        canardEncodeScalar(msg_buf, offset, 8, (void*)(source->input.data + c));// 255
        offset += 8;
    }
...
int32_t uavcan_protocol_AccessCommandShellRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellRequest* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    ...
    {
        // - Array length 8 bits
        ret = canardDecodeScalar(transfer, offset, 8, false, (void*)&dest->input.len); // 255
        if (ret != 8)
        {
            goto uavcan_protocol_AccessCommandShellRequest_error_exit;
        }
...
int32_t uavcan_protocol_AccessCommandShellRequest_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellRequest* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_protocol_AccessCommandShellRequest_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
...
uint32_t uavcan_protocol_AccessCommandShellResponse_encode_internal(uavcan_protocol_AccessCommandShellResponse* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    {
        canardEncodeScalar(msg_buf, offset, 8, (void*)(source->output.data + c));// 255
        offset += 8;
    }
...
int32_t uavcan_protocol_AccessCommandShellResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellResponse* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    ...
    {
        // - Array length 9 bits
        ret = canardDecodeScalar(transfer, offset, 9, false, (void*)&dest->output.len); // 255
        if (ret != 9)
        {
            goto uavcan_protocol_AccessCommandShellResponse_error_exit;
        }
...
int32_t uavcan_protocol_AccessCommandShellResponse_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellResponse* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_protocol_AccessCommandShellResponse_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
