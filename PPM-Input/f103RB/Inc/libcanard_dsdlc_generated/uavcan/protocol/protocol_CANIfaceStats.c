...
{
    source->frames_tx = CANARD_INTERNAL_SATURATE(source->frames_tx, 281474976710655)
    canardEncodeScalar(msg_buf, offset, 48, (void*)&source->frames_tx); // 281474976710655
    offset += 48;

    source->frames_rx = CANARD_INTERNAL_SATURATE(source->frames_rx, 281474976710655)
    canardEncodeScalar(msg_buf, offset, 48, (void*)&source->frames_rx); // 281474976710655
    offset += 48;

    source->errors = CANARD_INTERNAL_SATURATE(source->errors, 281474976710655)
...
/**
  ...
  */
int32_t uavcan_protocol_CANIfaceStats_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_CANIfaceStats* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    int32_t ret = 0;
