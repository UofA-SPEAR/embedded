...
uint32_t uavcan_protocol_Panic_encode_internal(uavcan_protocol_Panic* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    {
        canardEncodeScalar(msg_buf, offset, 8, (void*)(source->reason_text.data + c));// 255
        offset += 8;
    }
...
/**
  ...
  */
int32_t uavcan_protocol_Panic_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_Panic* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    int32_t ret = 0;
    uint32_t c = 0;
    ...
    {
        // - Array length 3 bits
        ret = canardDecodeScalar(transfer, offset, 3, false, (void*)&dest->reason_text.len); // 255
        if (ret != 3)
        {
...
int32_t uavcan_protocol_Panic_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_Panic* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_protocol_Panic_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
