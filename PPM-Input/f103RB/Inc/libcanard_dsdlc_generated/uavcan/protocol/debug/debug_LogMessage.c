...
uint32_t uavcan_protocol_debug_LogMessage_encode_internal(uavcan_protocol_debug_LogMessage* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    {
        canardEncodeScalar(msg_buf, offset, 8, (void*)(source->source.data + c));// 255
        offset += 8;
    }
    ...
    {
        canardEncodeScalar(msg_buf, offset, 8, (void*)(source->text.data + c));// 255
        offset += 8;
    }
...
int32_t uavcan_protocol_debug_LogMessage_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_protocol_debug_LogMessage* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    ...
    ret = canardDecodeScalar(transfer, offset, 5, false, (void*)&dest->source.len); // 255
    if (ret != 5)
    {
        goto uavcan_protocol_debug_LogMessage_error_exit;
    }
    ...
    {
        // - Array length 7 bits
        ret = canardDecodeScalar(transfer, offset, 7, false, (void*)&dest->text.len); // 255
        if (ret != 7)
        {
            goto uavcan_protocol_debug_LogMessage_error_exit;
        }
