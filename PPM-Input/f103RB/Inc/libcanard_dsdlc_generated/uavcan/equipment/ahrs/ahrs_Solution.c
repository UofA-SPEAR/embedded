...
uint32_t uavcan_equipment_ahrs_Solution_encode_internal(uavcan_equipment_ahrs_Solution* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    {
        canardEncodeScalar(msg_buf, offset, 16, (void*)(source->orientation_covariance.data + c));// 32767
        offset += 16;
    }
    ...
    {
        canardEncodeScalar(msg_buf, offset, 16, (void*)(source->angular_velocity_covariance.data + c));// 32767
        offset += 16;
    }
    ...
    {
        canardEncodeScalar(msg_buf, offset, 16, (void*)(source->linear_acceleration_covariance.data + c));// 32767
        offset += 16;
    }
...
int32_t uavcan_equipment_ahrs_Solution_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_ahrs_Solution* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    ...
    ret = canardDecodeScalar(transfer, offset, 4, false, (void*)&dest->orientation_covariance.len); // 32767
    if (ret != 4)
    {
        goto uavcan_equipment_ahrs_Solution_error_exit;
    }
    ...
    // Dynamic Array (angular_velocity_covariance)
    //  - Array length, not last item 4 bits
    ret = canardDecodeScalar(transfer, offset, 4, false, (void*)&dest->angular_velocity_covariance.len); // 32767
    if (ret != 4)
    {
        goto uavcan_equipment_ahrs_Solution_error_exit;
    }
    ...
    {
        // - Array length 4 bits
        ret = canardDecodeScalar(transfer, offset, 4, false, (void*)&dest->linear_acceleration_covariance.len); // 32767
        if (ret != 4)
        {
            goto uavcan_equipment_ahrs_Solution_error_exit;
        }
...
int32_t uavcan_equipment_ahrs_Solution_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_ahrs_Solution* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_equipment_ahrs_Solution_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
