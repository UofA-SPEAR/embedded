...
int32_t uavcan_equipment_air_data_RawAirData_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_air_data_RawAirData* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    ...
    {
        // - Array length 5 bits
        ret = canardDecodeScalar(transfer, offset, 5, false, (void*)&dest->covariance.len); // 32767
        if (ret != 5)
        {
            goto uavcan_equipment_air_data_RawAirData_error_exit;
        }
...
int32_t uavcan_equipment_air_data_RawAirData_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_air_data_RawAirData* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_equipment_air_data_RawAirData_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
