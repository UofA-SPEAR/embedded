...
uint32_t uavcan_equipment_indication_SingleLightCommand_encode_internal(uavcan_equipment_indication_SingleLightCommand* source, void* msg_buf, uint32_t offset, uint8_t root_item)
{
    ...
    // Compound
    offset = uavcan_equipment_indication_RGB565_encode_internal((void*)&source->color, msg_buf, offset, 0);
...
/**
  ...
  */
int32_t uavcan_equipment_indication_SingleLightCommand_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_indication_SingleLightCommand* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    int32_t ret = 0;
    ...
    // Compound
    offset = uavcan_equipment_indication_RGB565_decode_internal(transfer, 0, (void*)&dest->color, dyn_arr_buf, offset, tao);
    if (offset < 0)
    {
        ret = offset;
        goto uavcan_equipment_indication_SingleLightCommand_error_exit;
...
int32_t uavcan_equipment_indication_SingleLightCommand_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_indication_SingleLightCommand* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_equipment_indication_SingleLightCommand_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
