...
/**
  ...
  */
int32_t uavcan_equipment_actuator_ArrayCommand_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_actuator_ArrayCommand* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao)
{
    int32_t ret = 0;
    uint32_t c = 0;
    ...
    {
        // - Array length 4 bits
        ret = canardDecodeScalar(transfer, offset, 4, false, (void*)&dest->commands.len); // 0
        if (ret != 4)
        {
    ...
    {
        offset += uavcan_equipment_actuator_Command_decode_internal(transfer, 0, (void*)&dest->commands.data[c], dyn_arr_buf, offset, tao);
    }
    return offset;
...
int32_t uavcan_equipment_actuator_ArrayCommand_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_equipment_actuator_ArrayCommand* dest, uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_equipment_actuator_ArrayCommand_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
