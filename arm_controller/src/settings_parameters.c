...
char* parameters[NUM_PARAMETERS] = {
		...
		"spear.arm.motorA.continuous",
		"spear.arm.motorA.pid.Kp",
		"spear.arm.motorA.pid.Ki",
		"spear.arm.motorA.pid.Kd",
		"spear.arm.motorA.encoder.type",
		...
		"spear.arm.motorB.continuous",
		"spear.arm.motorB.pid.Kp",
		"spear.arm.motorB.pid.Ki",
		"spear.arm.motorB.pid.Kd",
		"spear.arm.motorB.encoder.type",
