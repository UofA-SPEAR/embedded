 ...
 * Custom assignments
 */
#define LINE_CAN_L                  PAL_LINE(GPIOA, 11U)
#define LINE_CAN_H                  PAL_LINE(GPIOA, 12U)
 ...
 * PA11 - CAN_L                     (alternate 9 can).
 * PA12 - CAN_H                     (alternate 9 can).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_ARD_A0) |         \
                                     ...
                                     PIN_MODE_ALTERNATE(CAN_L) |            \
                                     PIN_MODE_ALTERNATE(CAN_H) |            \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_ARD_D7, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(CAN_L, 9U) |               \
                                     PIN_AFIO_AF(CAN_H, 9U) |               \
