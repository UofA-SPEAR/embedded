...
C_SRCS += \
../inc/canard/drivers/avr/canard_avr.c 

OBJS += \
./inc/canard/drivers/avr/canard_avr.o 

C_DEPS += \
./inc/canard/drivers/avr/canard_avr.d 


# Each subdirectory must supply rules for building sources it contributes
inc/canard/drivers/avr/%.o: ../inc/canard/drivers/avr/%.c
	@echo 'Building file: $<'
